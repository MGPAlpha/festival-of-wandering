...
{
    [CreateAssetMenu(menuName = "Edgar/Examples/Minimap/Setup (legacy)", fileName = "MinimapExampleSetup")]
    public class MinimapExampleSetupLegacy : DungeonGeneratorPostProcessingGrid2D
    {
